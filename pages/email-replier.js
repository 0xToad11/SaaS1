  ...
  return (
    <div>
      ...
      <div className="lg:flex pt-6 lg:pt-20">
        <div className="text-xs lg:text-md lg:w-1/3 pl-2 lg:pl-20 border pt-2 lg:pt-8 pb-6 lg:pb-12 rounded-xl border-slate-500 ml-6 lg:ml-20 mr-6 lg:mr-0 text-slate-200">
        ...
        <div className="lg:w-1/2 pl-6 lg:pl-20 pr-6 lg:pr-0 pt-4 lg:pt-0">
          ...
          {responseMessage && (
          <div className="text-xs lg:text-md p-4 border rounded-xl border-slate-500 bg-slate-800 text-slate-200 whitespace-pre-wrap">
            <p>{responseMessage}</p>
          </div>
        )}
        </div>
